...
from pydanclick import ClickOpts, PydanclickConfig, from_pydantic
...
class OptimizerConfig(BaseModel):
    ...
    __pydanclick__ = PydanclickConfig(prefix="opt")
...
class LossConfig(BaseModel):
    ...
    func: Annotated[
        Literal["cross_entropy", "mse", "hinge"],
        ClickOpts(rename="--loss"),
        ClickOpts(shorten="-l"),
    ] = "cross_entropy"
    from_logits: bool = True

    __pydanclick__ = PydanclickConfig(prefix="loss", parse_docstring=False)
